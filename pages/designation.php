...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../dist/css/atlantis.css">
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    ?>
                ...
                <i class="glyphicon glyphicon-edit text-blue"></i></a>Edit
                &nbsp&nbsp&nbsp&nbsp&nbsp<a id="removeme" href="designation_del.php?id=<?php echo $id;?>">
                <i class="glyphicon glyphicon-remove text-red"></i></a>Remove
                </td>
