...
<html>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    ?>
                ...
                <i class="glyphicon glyphicon-file"></i></a>Set
                &nbsp&nbsp&nbsp&nbsp&nbsp<a id="removeme" href="settings_del.php?id=<?php echo $id;?>">
                <i class="glyphicon glyphicon-trash text-red"></i></a>Delete
                </td>
